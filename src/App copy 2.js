...
//   // Function to open a new tab with product details
...
//             <button class="add-to-cart" onclick="alert('Added to cart!')">Buy Now</button>
//           </body>
//         </html>
//       `);
//       newWindow.document.close(); // Close the document to allow rendering
//     }
//   };
...
//                 alt="Thumbnail"
//                 style={styles.productImage}
//                 onClick={() => openProduct(product)} // Open details in new tab
//               />
//               <span style={styles.discountBadge}>{product.discountPercentage}% OFF</span>
//             </div>
...
// //   // Function to open a new tab with product details
// //   const openProductDetailsInNewTab = (product) => {
// //     const { images, title, price, brand, category, rating, stock } = product;
// //     const newWindow = window.open();
// //     if (newWindow) {
// //       newWindow.document.write(`
...
// //                 alt="Thumbnail"
// //                 style={styles.productImage}
// //                 onClick={() => openProductDetailsInNewTab(product)} // Open details in new tab
// //               />
// //               <span style={styles.discountBadge}>{product.discountPercentage}% OFF</span>
// //             </div>
...
//     // Listen for messages from other windows (for cart count)
...
//   // Handle messages to update cart count
...
//               ${images.map((img) => `<img src="${img}" alt="Product Image" />`).join('')}
//             </div>
//             <button class="add-to-cart" onclick="window.opener.postMessage('addToCart', '*')">Add to Cart</button>
//           </body>
//         </html>
//       `);
...
//                 alt="Thumbnail"
//                 style={styles.productImage}
//                 onClick={() => openProductDetailsInNewTab(product)}
//               />
//               <span style={styles.discountBadge}>{product.discountPercentage}% OFF</span>
//             </div>
//             <h2 style={styles.productTitle}>{product.title}</h2>
